...
public class MaskHandler {
    ...
    public MaskHandler() throws IOException {
        rockBulletMask = createMaskFromTransparency(ImageIO.read(getClass().getResourceAsStream("../resource/bullets/rock.png")), Player.x, Player.y);
        paperBulletMask = createMaskFromTransparency(ImageIO.read(getClass().getResourceAsStream("../resource/bullets/paper.png")), 0, 0);
        scissorsBulletMask = createMaskFromTransparency(ImageIO.read(getClass().getResourceAsStream("../resource/bullets/scissors.png")), 0, 0);
    }
